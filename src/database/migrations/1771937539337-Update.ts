...
export class Update1771937539337 implements MigrationInterface {
    name = 'Update1771937539337'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exchange_rate" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "from_currency_code" character varying(3) NOT NULL, "to_currency_code" character varying(3) NOT NULL, "rate" numeric(10,4) NOT NULL, "fetched_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_5c5d27d2b900ef6cdeef0398472" PRIMARY KEY ("id"))`);
