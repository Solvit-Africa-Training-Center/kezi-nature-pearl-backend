...
export class Update1770300159905 implements MigrationInterface {
    name = 'Update1770300159905'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_preferences_skintype_enum" AS ENUM('dry', 'oily', 'combination', 'sensitive', 'normal')`);
        await queryRunner.query(`CREATE TABLE "user_preferences" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "skinType" "public"."user_preferences_skintype_enum", "skin_tone" character varying, "allergies" jsonb, "preferredCategories" uuid array, CONSTRAINT "UQ_b6202d1cacc63a0b9c8dac2abd4" UNIQUE ("userId"), CONSTRAINT "REL_b6202d1cacc63a0b9c8dac2abd" UNIQUE ("userId"), CONSTRAINT "PK_e8cfb5b31af61cd363a6b6d7c25" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."reviews_skintype_enum" AS ENUM('dry', 'oily', 'combination', 'sensitive', 'normal')`);
        await queryRunner.query(`CREATE TYPE "public"."reviews_status_enum" AS ENUM('pending', 'approved', 'rejected')`);
        await queryRunner.query(`CREATE TABLE "reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "productId" uuid NOT NULL, "orderId" uuid, "rating" integer NOT NULL, "title" character varying, "comment" text, "is_verified_purchase" boolean NOT NULL DEFAULT false, "skinType" "public"."reviews_skintype_enum", "helpful_count" integer NOT NULL DEFAULT '0', "status" "public"."reviews_status_enum" NOT NULL DEFAULT 'pending', CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('draft', 'active', 'inactive', 'discontinued', 'out_of_stock')`);
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "imageId" uuid, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text, "short_description" character varying, "sku" character varying NOT NULL, "brandId" uuid, "categoryId" uuid NOT NULL, "price" numeric(10,2) NOT NULL, "salePrice" numeric(10,2), "cost_price" numeric(10,2), "stock_quantity" integer NOT NULL DEFAULT '0', "low_stock_threshold" integer NOT NULL DEFAULT '10', "weight" numeric(10,2), "volume" character varying, "expiry_duration" integer, "ingredients" text, "benefits" text array, "how_to_use" text, "status" "public"."products_status_enum" NOT NULL DEFAULT 'draft', CONSTRAINT "UQ_464f927ae360106b783ed0b4106" UNIQUE ("slug"), CONSTRAINT "UQ_c44ac33a05b144dd0d9ddcf9327" UNIQUE ("sku"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_paymentmethod_enum" AS ENUM('card', 'upi', 'cod', 'bank_transfer')`);
        await queryRunner.query(`CREATE TYPE "public"."payments_paymentstatus_enum" AS ENUM('pending', 'paid', 'failed', 'refunded')`);
        await queryRunner.query(`CREATE TABLE "payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "orderId" uuid NOT NULL, "paymentMethod" "public"."payments_paymentmethod_enum" NOT NULL, "paymentStatus" "public"."payments_paymentstatus_enum" NOT NULL DEFAULT 'pending', "amount" numeric(10,2) NOT NULL, "transaction_id" character varying NOT NULL, "payment_gateway" character varying NOT NULL, "gateway_response" jsonb, "paid_at" TIMESTAMP WITH TIME ZONE, "refunded_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_3c324ca49dabde7ffc0ef64675d" UNIQUE ("transaction_id"), CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."coupons_discounttype_enum" AS ENUM('percentage', 'fixed')`);
        await queryRunner.query(`CREATE TABLE "coupons" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "code" character varying NOT NULL, "discountType" "public"."coupons_discounttype_enum" NOT NULL, "discount_value" numeric(10,2) NOT NULL, "min_order_amount" numeric(10,2), "max_discount_amount" numeric(10,2), "usage_limit" integer, "used_count" integer NOT NULL DEFAULT '0', "valid_from" TIMESTAMP WITH TIME ZONE NOT NULL, "valid_until" TIMESTAMP WITH TIME ZONE NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "applicableCategories" uuid array, CONSTRAINT "UQ_e025109230e82925843f2a14c48" UNIQUE ("code"), CONSTRAINT "PK_d7ea8864a0150183770f3e9a8cb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" DROP COLUMN "address_line1"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_preferences" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "user_preferences" DROP COLUMN "skin_tone"`);
        await queryRunner.query(`ALTER TABLE "user_preferences" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user_preferences" ADD "skin_tone" character varying`);
        await queryRunner.query(`ALTER TABLE "files" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "files" ADD "mime_type" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" ADD "address_line1" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "addresses" ADD "address_line2" character varying`);
        await queryRunner.query(`ALTER TABLE "addresses" ADD "postal_code" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" ADD "postalCode" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "addresses" ADD "phoneNumber" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "user_preferences" ADD "skinTone" character varying`);
        await queryRunner.query(`ALTER TABLE "files" ALTER COLUMN "type" SET DEFAULT 'image'`);
        ...
        await queryRunner.query(`ALTER TABLE "user_preferences" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "user_preferences" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "product_images" ADD CONSTRAINT "FK_195c571baada405f19e8a18466f" FOREIGN KEY ("fileId") REFERENCES "files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_preferences" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "user_preferences" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "updatedAt"`);
        ...
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "files" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "files" ALTER COLUMN "type" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_preferences" DROP COLUMN "skinTone"`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" DROP COLUMN "phoneNumber"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."reviews_skintype_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."inventory_log_changetype_enum"`);
        await queryRunner.query(`DROP TABLE "cart_items"`);
        await queryRunner.query(`DROP TABLE "carts"`);
        await queryRunner.query(`DROP TYPE "public"."carts_status_enum"`);
        await queryRunner.query(`DROP TABLE "categories"`);
        await queryRunner.query(`DROP TABLE "user_preferences"`);
        await queryRunner.query(`DROP TYPE "public"."user_preferences_skintype_enum"`);
    }
