...
export class Update1771320714818 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "addresses" ADD "province" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "addresses" ADD "district" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "addresses" ADD "sector" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "FK_a6e45c89cfbe8d92840266fd30f" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
